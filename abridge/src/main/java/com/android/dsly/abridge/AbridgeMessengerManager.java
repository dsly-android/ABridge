...
final class AbridgeMessengerManager {
    private static final String BIND_SERVICE_ACTION = "android.intent.action.BRIDGE_MESSENGER";
    private static final String BIND_MESSENGER_SERVICE_COMPONENT_NAME_CLS = "com.android.dsly.abridge.service.MessengerService";
